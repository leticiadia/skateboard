...
export function SectionAbout() {
  ...
  return (
    <section className="flex flex-col px-4 w-full min-h-[80vh] mt-8 xl:flex-row xl:items-center xl:justify-between xl:min-h-[80vh] xl:px-16 2xl:justify-evenly 2xl:min-h-[40vh] 2xl:px-[560px]">
      <div>
        <h2 className="text-2xl text-black font-bold md:text-4xl">
          Sobre a história do skate
        </h2>

        <div className="my-4 w-full md:w-[40rem]">
          <p>
